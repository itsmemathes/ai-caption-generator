...
quotes = {
    ...
    "money": [
        ...
        "It's better to check once in a while that you haven't lost the things money can't buy.",
    ...
    "pain": [
        ...
        "Sometimes pain is the only thing that lets you know you’re still alive.",
        ...
        "Healing is a process. It takes time and patience.",
    ...
    "family": [
        ...
        "The roots of a family tree begin with love.",
    ...
    "car": [
        ...
        "Life is too short to drive boring cars.",
        "Fuel your passion, not just your car.",
        "Cars are not just transportation; they are emotion on wheels.",
        "Four wheels move the body, but a great car moves the soul.",
        "A good car takes you places; a great car becomes your place.",
        "Shift gears, chase dreams.",
        "Drive it like you stole it.",
        "It’s not about the car, it’s about the drive.",
        "In a world full of traffic, be a race car."
    ],
    "bike": [
        "Life is better on two wheels.",
        "Ride fast, live free.",
...
def generate():
    ...
    if topic in quotes:
        selected = random.sample(quotes[topic], 10)
    else:
        selected = ["No quotes found for this topic."]
    return jsonify({"quotes": selected})
